      ...
      <div class="flex flex-col items-center justify-center mt-12">
        ...
        <div class="flex justify-between w-64 py-2">
          ...
          <input
            ...
            type="password" id="mot_de_passe" v-model="password" @input="validatePassword" placeholder="Mot de passe" />
          <button type="submit">
    ...
    async register() {
      try {
        ...
        if (error.response && error.response.data) {
          ...
          this.registerError = 'Une erreur s\'est produite lors de l\'inscription.';
        }
